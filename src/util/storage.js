...
class Storage {
  ...
  constructor({ type = 'localStorage', prefix = '__PET__' }) {
    this.prefix = prefix;
    this.type = type;
...
const clearLoginInfo = () => storage.remove(frontLoginKey);
...
const setLoginInfo = obj => storage.set(frontLoginKey, obj);

const getLoginInfo = () => storage.get(frontLoginKey);

export { sessionStore, setLoginInfo, getLoginInfo, clearLoginInfo, clearAll };
